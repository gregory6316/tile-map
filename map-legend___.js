...
`), function(u) {
    ...
    class vl {
        ...
        onAdd(e) {
            ...
            o.classList.add("maplibregl-legend-onlyRendered-label"), o.textContent = "Only ", o.htmlFor = i, this.legendContainer.appendChild(o), this.legendContainer.appendChild(document.createElement("br")), this.map.on("moveend", () => {
